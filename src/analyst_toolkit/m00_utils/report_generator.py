...
def generate_transformation_report(
    ...
    # 2. Long-form diff table (Vectorized)
    # changed_rows from .compare() already contains only the cells that differ.
    # We melt it to get the column-original-transformed format.
