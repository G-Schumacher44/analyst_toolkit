...
def plot_imputation_comparison(s_before: pd.Series, s_after: pd.Series, save_dir: Path, run_id: str) -> Path:
    """
...
def plot_categorical_imputation_comparison(s_before: pd.Series, s_after: pd.Series, save_dir: Path, run_id: str) -> Path:
    """
